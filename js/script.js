...
function add() {
  ...
  var strawberryBannana = new Option(
    "Strawberry Bannana",
    "straw_bannana",
    false,
    false
  );
  var strawberryKiwi = new Option(
    "Strawberry Kiwi",
    "straw_kiwi",
    false,
    false
  ...
  var greenWatermelon = new Option(
    "Green Watermelon",
    "watermelon",
    false,
    false
  ...
  var orangePineapple = new Option(
    "Orange Pineapple",
    "orange_pineapple",
    false,
    false
  ...
  var whiteGrapeCF = new Option(
    "White Grape (Color Free)",
    "white_grape_cf",
    false,
    false
  );
  var peachMangoCF = new Option(
    "Peach Mango (Color Free)",
    "peach_mango_cf",
    false,
    false
  );
  var orangeRaspberryCF = new Option(
  ...
  var tangerineCF = new Option(
    "Tangerine (Color Free)",
    "tangerine_cf",
    false,
    false
  );
  var fruitPunchCF = new Option(
